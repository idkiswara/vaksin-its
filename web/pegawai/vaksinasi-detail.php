    ...
    <aside class="aside aside-fixed">
            ...
            <div class="aside-body">
                <ul class="nav nav-aside">
                    ...
                    <li class="nav-item"><a href="../pegawai/riwayat.php" class="nav-link"><i data-feather="clock"></i> <span>Riwayat</span></a></li>
                    <li class="nav-item"><a href="../pegawai/vaksinasi.php" class="nav-link"><i data-feather="calendar"></i> <span>Jadwal vaksinasi</span></a></li>
                </ul>
            </div>
    </aside>
            ...
            <div>
              <nav aria-label="breadcrumb" class="d-none d-lg-block">
                <ol class="breadcrumb breadcrumb-style2 mg-b-10">
                  ...
                  <li class="breadcrumb-item"><a href="../pegawai/vaksinasi.php">Jadwal Vaksinasi</a></li>
