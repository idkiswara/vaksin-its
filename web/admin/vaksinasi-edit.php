      ...
      <div class="content-body ht-100p pd-t-80">
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
              <nav aria-label="breadcrumb" class="d-none d-lg-block">
                <ol class="breadcrumb breadcrumb-style2 mg-b-10">
                  ...
                  <li class="breadcrumb-item"><a href="../admin/vaksinasi.php">Vaksinasi Tersedia</a></li>
                  <li class="breadcrumb-item"><a href="../admin/vaksinasi-detail.php">Detail Vaksinasi</a></li>
            ...
            <div>
              <a href="vaksinasi-detail.php"  class="btn btn-white tx-montserrat tx-semibold"><i data-feather="arrow-left" class="wd-10 mg-r-5"></i> Kembali</a>
            </div>
          </div>
