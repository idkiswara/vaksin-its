...
<html lang="en">
  ...
  <body>
    ...
    <aside class="aside aside-fixed">
            ...
            <a href="../../index.php" class="tx-montserrat tx-semibold tx-18 aside-logo">myITS Vaksin</a>
        ...
        <div class="aside-body">
            <ul class="nav nav-aside">
                <li class="nav-item"><a href="../beranda/index-admin.php" class="nav-link"><i data-feather="home"></i> <span>Beranda</span></a></li>
                <li class="nav-label mg-t-15">Kelola</li>
                <li class="nav-item"><a href="../admin/vaksinasi.php" class="nav-link"><i data-feather="calendar"></i> <span>Jadwal Vaksinasi</span></a></li>
                <li class="nav-item"><a href="../admin/laporan.php" class="nav-link"><i data-feather="clipboard"></i> <span>Laporan</span></a></li>
                <li class="nav-label mg-t-15">Data</li>
                <li class="nav-item"><a href="../admin/pegawai.php" class="nav-link"><i data-feather="user"></i> <span>Pegawai</span></a></li>
                <li class="nav-item"><a href="../admin/vaksinator.php" class="nav-link"><i data-feather="users"></i> <span>Vaksinator</span></a></li>
                <li class="nav-item"><a href="../admin/jenis-vaksin.php" class="nav-link"><i data-feather="copy"></i> <span>Jenis Vaksin</span></a></li>
            </ul>
        </div>
    </aside>
    ...
    <div class="content ht-100v pd-0" style="position: relative">
          ...
          <div>
              <a href="../../index.php" class="tx-montserrat tx-semibold tx-18 d-lg-none">myITS Vaksin</a>
          </div>
          <nav class="nav r-25 pos-fixed z-index-10">
              <div class="dropdown dropdown-profile allow-focus">
                ...
                <div class="dropdown-menu dropdown-menu-right allow-focus">
                  ...
                  <a href="../dashboard/login-mhs.php" class="dropdown-item ht-30"><i data-feather="log-out"></i>Keluar</a>
                </div>
              </div>
          </nav>
      </div>
          ...
          <div class="modal-content bg-white">
            <div class="modal-body">
              ...
              <select class="form-control" id="menu">
                ...
                <option value="../beranda/index-admin.php">Admin</option>
              </select>
      ...
      <div class="content-body ht-100p pd-t-80">
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
              <nav aria-label="breadcrumb" class="d-none d-lg-block">
                <ol class="breadcrumb breadcrumb-style2 mg-b-10">
                  ...
                  <li class="breadcrumb-item"><a href="../admin/vaksinasi.php">Jadwal Vaksinasi</a></li>
            ...
            <div>
              <a href="vaksinasi.php"  class="btn btn-white tx-montserrat tx-semibold"><i data-feather="arrow-left" class="wd-10 mg-r-5"></i> Kembali</a>
            </div>
          </div>
                    ...
                    <div class="col-2 col-sm-2 col-lg-2 d-flex align-items-center justify-content-end">
                      <div class="dropdown dropdown-custom">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="vaksinasi-edit.php"><i data-feather="edit"></i>Edit</a>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row row-xs">
                    ...
                    <div class="col-2 col-sm-2 col-lg-2 d-flex align-items-center justify-content-end">
                      <a href="vaksinasi-peserta.php" class="btn btn-white tx-montserrat tx-semibold float-right d-none d-lg-block"><i data-feather="edit" class="wd-10 mg-r-5"></i> Edit Peserta</a>
                      <a href="vaksinasi-peserta.php" class="btn btn-white btn-icon tx-montserrat tx-medium float-right d-lg-none"><i data-feather="edit"></i></a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
